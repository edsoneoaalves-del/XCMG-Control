...
function exigirAdministrador(){if(usuarioAtual?.administrador)return true;alert('Somente o administrador pode gerenciar categorias e motivos.');return false}
