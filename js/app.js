...
function aplicarPermissoes(){
  const mapaPaginas={dashboard:'dashboard_ver',ocorrencias:'ocorrencias_cadastrar',colaboradores:'colaboradores_ver',homemfrota:'colaboradores_ver',escala:'dashboard_ver',ferias:'ferias_ver',registros:'registros_ver',mensagem:'whatsapp_gerar',configuracoes:'configuracoes_ver',usuarios:'usuarios_gerenciar'};
...
$('btnAbrirImportacaoHF')?.addEventListener('click',()=>{$('hfImportBox')?.classList.toggle('hidden');$('hfEditorBox')?.classList.add('hidden')});
